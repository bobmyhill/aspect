...
namespace aspect
{
  namespace MaterialModel
  {
             ...
             MaterialModelOutputs &out) const
    {
	  ...
	  // Find the inidividual components of the viscosities
	  ...
	  const double viscosity_peierls = std::min(1e22,(1e0/prefactor_peierls)*
						    ...
						    std::exp(peierls_factor*(activation_energy_peierls+activation_volume_peierls*reference_density()*g*z)/(R*temperature)));
